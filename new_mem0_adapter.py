...
class Mem0Adapter:
    ...
    def _initialize(self) -> None:
        ...
        try:
            ...
            # Configure mem0ai with Ollama based on the repository structure
            # Checking the actual parameters the embedder accepts
            ...
            # Based on the source code from embeddings/ollama.py and configs/embeddings/base.py
            config = {
                "llm": {
                    "provider": "ollama",
                    "config": {
                        "model": self.default_model,
                        # The parameter is `ollama_base_url` in BaseEmbedderConfig
